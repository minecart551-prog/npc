...
public interface IComponentsWrapper {
     ...
     * Add a colored line
     * @param id - Unique ID for identifying this component.
     * @param xStart - Start X Position, relative to the Left side of the GUI window.
     * @param yStart - Start Y Position, relative to the Top of the GUI window.
     * @param xEnd - End X Position, relative to the Left side of the GUI window.
     * @param yEnd - End Y Position, relative to the Top of the GUI window.
     ...
     * @param x - X Position, relative to the Left side of the GUI window.
     * @param y - Y Position, relative to the Top of the GUI window.
     * @param width - Width of the ItemRenderer hover box.
     * @param height - Height of the ItemRenderer hover box.
     * @param stack - ItemStack to display
     */
    IItemRenderer addItemRenderer(int id, final int x, final int y, int width, int height, final IItemStack stack);
