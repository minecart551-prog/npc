...
//
//
//    protected void renderDrop(EntityRendererProvider.Context rendermanager, EntityNpcPony entityplayer, ModelPart modelrenderer, float f, float f1, float f2, float f3)
//    {
...
//                RenderSystem.setShaderColor(f9, f10, f12, 1.0F);
