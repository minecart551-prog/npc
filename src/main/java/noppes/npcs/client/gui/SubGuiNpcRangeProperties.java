...
public class SubGuiNpcRangeProperties extends GuiBasic implements ITextfieldListener {
    ...
    public void init(){
        ...
        addLabel(new GuiLabel(1,"stats.accuracy", guiLeft + 5, y + 5, "guihint.npcaccuracy"));
    	...
    	addLabel(new GuiLabel(8, "stats.shotcount", guiLeft + 135, y + 5, "guihint.npcshotcount"));
        ...
        addLabel(new GuiLabel(2,"gui.range", guiLeft + 5, y + 5, "guihint.npcrange"));
		...
		addLabel(new GuiLabel(16, "stats.meleerange", guiLeft + 135, y + 5, "guihint.npcmeleerange"));
        ...
        addLabel(new GuiLabel(3,"stats.mindelay", guiLeft + 5, y + 5, "guihint.npcmindelay"));
        ...
        addLabel(new GuiLabel(4,"stats.maxdelay", guiLeft + 135, y + 5, "guihint.npcmaxdelay"));
    	...
    	addLabel(new GuiLabel(6, "stats.burstcount", guiLeft + 5, y + 5, "guihint.npcburstcount"));
        ...
        addLabel(new GuiLabel(5, "stats.burstspeed", guiLeft + 135, y + 5, "guihint.npcburstrate"));
    	...
    	addLabel(new GuiLabel(7, "stats.firesound", guiLeft + 5, y + 5, "guihint.npcfiresound"));
    	...
    	addLabel(new GuiLabel(11, "stats.hitsound", guiLeft + 5, y + 5, "guihint.npchitsound"));
    	...
    	addLabel(new GuiLabel(10, "stats.groundsound", guiLeft + 5, y + 5, "guihint.npcgroundsound"));
    	...
    	addLabel(new GuiLabel(9, "stats.aimWhileShooting", guiLeft + 5, y + 5, "guihint.npcwhileshooting"));
    	...
    	addLabel(new GuiLabel(13, "stats.indirect", guiLeft + 5, y + 5, "guihint.npcshootindirect"));
