...
public class SubGuiNpcMeleeProperties extends GuiBasic implements ITextfieldListener {
    ...
    public void init(){
        super.init();
        addLabel(new GuiLabel(1,"stats.meleestrength", guiLeft + 5, guiTop + 15,"guihint.npcdamage"));
        addTextField(new GuiTextFieldNop(1,this,  guiLeft + 105, guiTop + 10, 100, 18, stats.getStrength()+""));
        getTextField(1).numbersOnly = true;
        getTextField(1).setMinMaxDefault(0, Integer.MAX_VALUE, 5);
        addLabel(new GuiLabel(2,"stats.meleerange", guiLeft + 5, guiTop + 45,"guihint.npcattackrange"));
        addTextField(new GuiTextFieldNop(2,this,  guiLeft + 105, guiTop + 40, 100, 18, stats.getRange()+""));
        getTextField(2).numbersOnly = true;
        getTextField(2).setMinMaxDefault(1, 30, 2);
        addLabel(new GuiLabel(3,"stats.meleespeed", guiLeft + 5, guiTop + 75, "guihint.npcattackspeed"));
        addTextField(new GuiTextFieldNop(3,this,  guiLeft + 105, guiTop + 70, 100, 18, stats.getDelay()+""));
        getTextField(3).numbersOnly = true;
        getTextField(3).setMinMaxDefault(1, 1000, 20);

        addLabel(new GuiLabel(4,"enchantment.minecraft.knockback", guiLeft + 5, guiTop + 105, "guihint.npcknockback"));
		addTextField(new GuiTextFieldNop(4,this,  guiLeft + 105, guiTop + 100, 100, 18, stats.getKnockback() + ""));
		getTextField(4).numbersOnly = true;
		getTextField(4).setMinMaxDefault(0, 4, 0);
        addLabel(new GuiLabel(5,"stats.meleeeffect", guiLeft + 5, guiTop + 135, "guihint.npceffect"));
