...
public class SubGuiNpcMovement extends GuiBasic implements ITextfieldListener
{
    ...
    public void init(){
        super.init();
        int y = guiTop + 4;
        this.addLabel(new GuiLabel(0, "movement.type", guiLeft + 4, y + 5, "guihint.movement.movetype"));
        ...
        this.addLabel(new GuiLabel(15, "movement.navigation", guiLeft + 4, y + 5, "guihint.movement.navigation"));
    	
		if(ai.getMovingType() == 1){    
			addTextField(new GuiTextFieldNop(4,this, guiLeft + 100, y += 22, 60, 20, ai.walkingRange + ""));
	    	getTextField(4).numbersOnly = true;
	        getTextField(4).setMinMaxDefault(0, 1000, 10);
	        addLabel(new GuiLabel(4,"gui.range", guiLeft + 4, y + 5));

			addTextField(new GuiTextFieldNop(10,this, guiLeft + 100, y += 22, 60, 20, ai.activeRange + ""));
			getTextField(10).numbersOnly = true;
			getTextField(10).setMinMaxDefault(32, 1000, 10);
			addLabel(new GuiLabel(10,"gui.activerange", guiLeft + 4, y + 5));
			...
			addLabel(new GuiLabel(17, "spawner.posoffset", guiLeft + 4, y + 27, "guihint.movement.pos"));
	        ...
	        getTextField(8).setMinMaxDefault(0, 100, 5);
			...
			this.addLabel(new GuiLabel(3, "movement.animation", guiLeft + 4, y + 5, "guihint.movement.animation"));
			...
			if(ai.animationType != AnimationType.SLEEP){
				...
				this.addLabel(new GuiLabel(1, "movement.rotation", guiLeft + 4, y + 5, "guihint.movement.rotation"));
	        }
			else{
        ...
        addLabel(new GuiLabel(13,"movement.stopinteract", guiLeft + 4, y + 5, "guihint.movement.isignore"));

        addTextField(new GuiTextFieldNop(14,this, guiLeft + 80, y += 22, 50, 18, ai.getWalkingSpeed()+""));
        getTextField(14).numbersOnly = true;
        getTextField(14).setMinMaxDefault(0, 100, 4);
        addLabel(new GuiLabel(14,"stats.movespeed", guiLeft + 5, y + 5, "guihint.movement.speed"));
	...
	public void buttonEvent(GuiButtonNop guibutton){
		...
		if(button.id == 0){
			...
			if(ai.getMovingType() != 0){
				ai.animationType = AnimationType.NONE;
			...
			if(button.getValue() == 1)
				ai.animationType = AnimationType.CROUCH;
	...
	public void unFocused(GuiTextFieldNop textfield) {
		if(textfield.id == 7){
			...
			ai.activeRange = textfield.getInteger();
		}
