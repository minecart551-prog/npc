...
public class GuiMerchantAdd extends AbstractContainerScreen<ContainerMerchantAdd> implements IGuiInterface
{
...
//     */
//    protected void renderLabels(PoseStack matrixStack, int par1, int limbSwingAmount)
//    {
...
//        minecraft.getTextureManager().bindForSetup(merchantGuiTextures);
...
//                if (this.visible)
//                {
//                    Minecraft.getInstance().getTextureManager().bindForSetup(GuiMerchantAdd.merchantGuiTextures);
//                    RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
