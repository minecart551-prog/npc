...
public class GuiNpcRemoteEditor extends GuiNPCInterface implements IScrollData {
    ...
    public void init(){
        ...
        this.addButton(new GuiButtonNop(this, 1, guiLeft + 170, guiTop + 28,82,20, "selectServer.delete"));
	...
	public void buttonEvent(GuiButtonNop guibutton){
    	...
    	if(id == 1){
            ConfirmScreen guiyesno = new ConfirmScreen((bo) -> {
				...
				NoppesUtil.openGUI(player, this);}, Component.translatable(""),Component.translatable("gui.deleteMessage"));
            setScreen(guiyesno);
    	}
    	if(id == 2){
