...
public class GuiNpcMenu{
    ...
    public void initGui(int guiLeft, int guiTop, int width){
        ...
        GuiMenuTopButton stats = new GuiMenuTopButton(parent,2,display.getX() + display.getWidth() , guiTop - 17, "menu.stats"){
			@Override
			public void onClick(double x, double y){
				save();
				activeMenu = 2;
        ...
        GuiMenuTopButton ai = new GuiMenuTopButton(parent,3,stats.getX() + stats.getWidth() , guiTop - 17, "menu.ai"){
			@Override
			public void onClick(double x, double y){
				save();
				activeMenu = 3;
        ...
        GuiMenuTopButton inv = new GuiMenuTopButton(parent,4,ai.getX() + ai.getWidth() , guiTop - 17,  "menu.inventory"){
        	@Override
        	public void onClick(double x, double y){
				save();
				activeMenu = 4;
        ...
        GuiMenuTopButton advanced = new GuiMenuTopButton(parent,5,inv.getX() + inv.getWidth() , guiTop - 17, "menu.advanced"){
			@Override
			public void onClick(double x, double y){
				save();
				activeMenu = 5;
        ...
        GuiMenuTopButton global = new GuiMenuTopButton(parent,6,advanced.getX() + advanced.getWidth() , guiTop - 17, "menu.global"){
			@Override
			public void onClick(double x, double y){
				save();
				activeMenu = 6;
        ...
        GuiMenuTopButton delete = new GuiMenuTopButton(parent,66,guiLeft + width - 72, guiTop - 17,"selectServer.delete"){
			@Override
			public void onClick(double x, double y){
				ConfirmScreen guiyesno = new ConfirmScreen(GuiNpcMenu.this::accept, Component.translatable(""), Component.translatable("gui.deleteMessage", npc.getDisplayName().getString()));
	...
	public void drawElements(GuiGraphics graphics, Font font, int i, int j,
