...
public class SubGuiNpcProjectiles extends GuiBasic implements ITextfieldListener {
    ...
    public void init(){
        super.init();
        addLabel(new GuiLabel(1,"effect.minecraft.strength", guiLeft + 5, guiTop + 15, "guihint.npcstrength"));
        ...
        addLabel(new GuiLabel(2,"enchantment.minecraft.knockback", guiLeft + 110, guiTop + 15, "guihint.npcknockbackprojectile"));
        ...
        addLabel(new GuiLabel(3,"stats.size", guiLeft + 5, guiTop + 45, "guihint.npcsizeprojectile"));
        ...
        addLabel(new GuiLabel(4,"stats.speed", guiLeft + 5, guiTop + 75, "guihint.npcspeedprojectile"));
        ...
        addLabel(new GuiLabel(5,"stats.hasgravity", guiLeft + 5, guiTop + 105, "guihint.npcgravity"));
    	...
    	addLabel(new GuiLabel(6,"stats.explosive", guiLeft + 5, guiTop + 135, "guihint.npcexplodes"));
    	...
    	addLabel(new GuiLabel(7,"stats.rangedeffect", guiLeft + 5, guiTop + 165, "guihint.npceffectprojectile"));
    	...
    	addLabel(new GuiLabel(8,"stats.trail", guiLeft + 5, guiTop + 195, "guihint.npctrailprojectile"));
