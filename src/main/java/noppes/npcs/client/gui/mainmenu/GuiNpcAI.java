...
public class GuiNpcAI extends GuiNPCInterface2 implements ITextfieldListener, IGuiData{
    ...
    public void init() {
        super.init();
        addLabel(new GuiLabel(0,"ai.enemyresponse", guiLeft + 5, guiTop + 17, "guihint.npconfoundenemy"));
    	...
    	addLabel(new GuiLabel(1,"ai.door", guiLeft + 5, guiTop + 40, "guihint.npcdoorinteract"));
    	...
    	addLabel(new GuiLabel(12,"ai.swim", guiLeft + 5, guiTop + 65, "guihint.npccanswim"));
    	addButton(new GuiButtonNop(this, 7,guiLeft + 86, guiTop + 60, 60, 20, new String[]{"gui.no", "gui.yes"} ,npc.ais.canSwim ? 1:0));
    	addLabel(new GuiLabel(13,"ai.shelter", guiLeft + 5, guiTop + 90, "guihint.npcshelterfrom"));
    	...
    	addLabel(new GuiLabel(14,"ai.clearlos", guiLeft + 5, guiTop + 115, "guihint.npcmustseetarget"));
		...
		this.addButton(new GuiButtonNop(this, 16, this.guiLeft + 230, this.guiTop + 85, 60, 20, new String[] { "gui.no", "gui.yes" }, this.npc.ais.mountControl ? 1 : 0));
	}
