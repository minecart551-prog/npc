...
public class GuiNpcDisplay extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
    ...
    public void init(){
        super.init();
        int y = guiTop + 4;
        addLabel(new GuiLabel(0,"gui.name", guiLeft + 5, y + 5,"guihint.npcname"));
    	...
    	y+=23;
        addLabel(new GuiLabel(11,"gui.title", guiLeft + 5, y + 5,"guihint.npctitle"));
        addTextField(new GuiTextFieldNop(11,this,  guiLeft + 50, y, 186, 20, display.getTitle()));

    	y+=23;
        addLabel(new GuiLabel(1,"display.model", guiLeft + 5, y + 5,"guihint.npcmodel"));
    	this.addButton(new GuiButtonNop(this, 1, guiLeft + 50, y,110,20, "selectServer.edit"));
    	addLabel(new GuiLabel(2,"display.size", guiLeft + 175, y + 5,"guihint.npcsize"));
    	...
    	y+=23;
    	addLabel(new GuiLabel(4,"display.texture", guiLeft + 5, y + 5,"guihint.npctexture"));
    	...
    	y+=23;
    	addLabel(new GuiLabel(8,"display.cape", guiLeft + 5, y + 5,"guihint.npccape"));
    	...
    	y+=23;
    	addLabel(new GuiLabel(9,"display.overlay", guiLeft + 5, y + 5,"guihint.npcoverlay"));
        addTextField(new GuiTextFieldNop(9,this,  guiLeft + 80, y, 200, 20, display.getOverlayTexture()));
    	this.addButton(new GuiButtonNop(this, 9, guiLeft + 283, y, 38, 20, "mco.template.button.select"));
		addLabel(new GuiLabel(14,"display.isglowing", guiLeft + 325, y + 5));
		this.addButton(new GuiButtonYesNo(this, 18, guiLeft +  365, y, 40, 20,display.isOverlayGlowing()));

    	y+=23;
    	addLabel(new GuiLabel(5,"display.livingAnimation", guiLeft + 5, y + 5,"guihint.npchasliving"));
    	this.addButton(new GuiButtonNop(this, 5, guiLeft + 120, y, 50, 20, new String[]{"gui.yes","gui.no"},display.getHasLivingAnimation()?0:1));

    	addLabel(new GuiLabel(6,"display.tint", guiLeft + 180, y + 5,"guihint.npctint"));
    	...
    	y+=23;
    	addLabel(new GuiLabel(7,"display.visible", guiLeft + 5, y + 5,"guihint.npcvisible"));
    	...
    	addLabel(new GuiLabel(13,"display.hitbox", guiLeft + 180, y + 5,"guihint.npchitbox"));
    	...
    	y+=23;
    	addLabel(new GuiLabel(10,"display.bossbar", guiLeft + 5, y + 5,"guihint.npcbossbar"));
    	...
    	addLabel(new GuiLabel(12,"gui.color", guiLeft + 180, y + 5, "guihint.npcbossbarcolor"));
	...
	public void buttonEvent(GuiButtonNop guibutton){
		...
		if(button.id == 1){
			NoppesUtil.openGUI(player, new GuiCreationEntities((EntityCustomNpc) npc));
		...
		if(button.id == 2){
			...
			setSubGui(new GuiTextureSelection(npc, npc.display.getSkinTexture(), 0));
		}
		else if(button.id == 5){
			...
			setSubGui(new GuiTextureSelection(npc, npc.display.getCapeTexture(), 1));
		}
		else if(button.id == 9){
			setSubGui(new GuiTextureSelection(npc, npc.display.getOverlayTexture(), 2));
		}
			...
			display.setOverlayGlowing(((GuiButtonYesNo)button).getBoolean());
		}
    }
	...
	public void save() {
		...
		Packets.sendServer(new SPacketMenuSave(EnumMenuType.DISPLAY, display.save(new CompoundTag())));
