...
public class GuiNPCManageBanks extends GuiContainerNPCInterface2<ContainerManageBanks> implements IScrollData,ICustomScrollListener,ITextfieldListener, IGuiData
{
    ...
    protected void renderLabels(GuiGraphics graphics, int par1, int limbSwingAmount)
    {
		...
		graphics.drawString(font, I18n.get("bank.tabCost"), 23, 28, CustomNpcResourceListener.DefaultTextColor, false);
		graphics.drawString(font, I18n.get("bank.upgCost"), 123, 28, CustomNpcResourceListener.DefaultTextColor, false);
		graphics.drawString(font, I18n.get("gui.start"), 6, 70, CustomNpcResourceListener.DefaultTextColor, false);
		graphics.drawString(font,  I18n.get("gui.max"), 9, 100, CustomNpcResourceListener.DefaultTextColor, false);
    }
