...
public class GuiNpcManagePlayerData extends GuiNPCInterface2 implements IScrollData,ICustomScrollListener
{
    ...
    public void init(){
        ...
        this.addButton(new GuiButtonNop(this, 0, guiLeft + 200, guiTop + 10,98, 20, "selectServer.delete"));
    ...
    public void initButtons(){
    	...
    	if(selection == EnumPlayerData.Players)
    		getLabel(0).setMessage(Component.translatable("playerdata.allPlayers"));
    	else
    		getLabel(0).setMessage(Component.translatable("playerdata.selectedPlayer", selectedPlayer));
    }
