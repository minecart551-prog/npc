...
//                animationSpeed = 0;
            ...
            leftFrontLeg.xRot = rightFrontLeg.xRot = Mth.cos((float) (animationPos * 0.6662F + (Math.PI))) * 0.6F * animationSpeed + 0.45f + f7 * 0.5f ;
            leftRearLeg.xRot = rightRearLeg.xRot = Mth.cos((float) (animationPos * 0.6662F + (0))) * 0.6F * animationSpeed + 0.75f + f7 * 0.5f;
