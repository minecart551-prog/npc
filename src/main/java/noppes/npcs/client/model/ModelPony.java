...
public class ModelPony<T extends EntityNpcPony> extends EntityModel<T>
{
    ...
    public void init(float strech,float f)
    {
        ...
        float f3 = 0.0F;
        float f4 = 0.0F;
        Head = new NopModelPart(64, 32, 0, 0);
        Head.addBox(-4F, -4F, -6F, 8, 8, 8);
        Head.setPos(f2, f3 + f, f4);
        Headpiece = new NopModelPart[3];
        Headpiece[0] = new NopModelPart(64, 32, 12, 16);
        Headpiece[0].addBox(-4F, -6F, -1F, 2, 2, 2);
        Headpiece[0].setPos(f2, f3 + f, f4);
        Headpiece[1] = new NopModelPart(64, 32, 12, 16);
        Headpiece[1].addBox(2.0F, -6F, -1F, 2, 2, 2);
        Headpiece[1].setPos(f2, f3 + f, f4);
        Headpiece[2] = new NopModelPart(64, 32, 56, 0);
        Headpiece[2].addBox(-0.5F, -10F, -4F, 1, 4, 1);
        Headpiece[2].setPos(f2, f3 + f, f4);
        Helmet = new NopModelPart(64, 32, 32, 0);
        Helmet.addBox(-4F, -4F, -6F, 8, 8, 8 + 0.5F);
        Helmet.setPos(f2, f3, f4);
        float f5 = 0.0F;
        float f6 = 0.0F;
        float f7 = 0.0F;
        Body = new NopModelPart(64, 32, 16, 16);
        Body.addBox(-4F, 4F, -2F, 8, 8, 4);
        Body.setPos(f5, f6 + f, f7);
        Bodypiece = new ModelPlaneRenderer[13];
        Bodypiece[0] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[0].addSidePlane(-4F, 4F, 2.0F, 8, 8);
        Bodypiece[0].setPos(f5, f6 + f, f7);
        Bodypiece[1] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[1].addSidePlane(4F, 4F, 2.0F, 8, 8);
        Bodypiece[1].setPos(f5, f6 + f, f7);
        Bodypiece[2] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[2].addTopPlane(-4F, 4F, 2.0F, 8, 8);
        Bodypiece[2].setPos(f2, f3 + f, f4);
        Bodypiece[3] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[3].addTopPlane(-4F, 12F, 2.0F, 8, 8);
        Bodypiece[3].setPos(f2, f3 + f, f4);
        Bodypiece[4] = new ModelPlaneRenderer(64, 32, 0, 20);
        Bodypiece[4].addSidePlane(-4F, 4F, 10F, 8, 4);
        Bodypiece[4].setPos(f5, f6 + f, f7);
        Bodypiece[5] = new ModelPlaneRenderer(64, 32, 0, 20);
        Bodypiece[5].addSidePlane(4F, 4F, 10F, 8, 4);
        Bodypiece[5].setPos(f5, f6 + f, f7);
        Bodypiece[6] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[6].addTopPlane(-4F, 4F, 10F, 8, 4);
        Bodypiece[6].setPos(f2, f3 + f, f4);
        Bodypiece[7] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[7].addTopPlane(-4F, 12F, 10F, 8, 4);
        Bodypiece[7].setPos(f2, f3 + f, f4);
        Bodypiece[8] = new ModelPlaneRenderer(64, 32, 24, 0);
        Bodypiece[8].addBackPlane(-4F, 4F, 14F, 8, 8);
        Bodypiece[8].setPos(f2, f3 + f, f4);
        Bodypiece[9] = new ModelPlaneRenderer(64, 32, 32, 0);
        Bodypiece[9].addTopPlane(-1F, 10F, 8F, 2, 6);
        Bodypiece[9].setPos(f2, f3 + f, f4);
        Bodypiece[10] = new ModelPlaneRenderer(64, 32, 32, 0);
        Bodypiece[10].addTopPlane(-1F, 12F, 8F, 2, 6);
        Bodypiece[10].setPos(f2, f3 + f, f4);
        Bodypiece[11] = new ModelPlaneRenderer(64, 32, 32, 0);
        Bodypiece[11].mirror = true;
        Bodypiece[11].addSidePlane(-1F, 10F, 8F, 2, 6);
        Bodypiece[11].setPos(f2, f3 + f, f4);
        Bodypiece[12] = new ModelPlaneRenderer(64, 32, 32, 0);
        Bodypiece[12].addSidePlane(1.0F, 10F, 8F, 2, 6);
        Bodypiece[12].setPos(f2, f3 + f, f4);
        RightArm = new NopModelPart(64, 32, 40, 16);
        RightArm.addBox(-2F, 4F, -2F, 4, 12, 4);
        RightArm.setPos(-3F, 8F + f, 0.0F);
        LeftArm = new NopModelPart(64, 32, 40, 16);
        LeftArm.mirror = true;
        LeftArm.addBox(-2F, 4F, -2F, 4, 12, 4);
        LeftArm.setPos(3F, 8F + f, 0.0F);
        RightLeg = new NopModelPart(64, 32, 40, 16);
        RightLeg.addBox(-2F, 4F, -2F, 4, 12, 4);
        RightLeg.setPos(-3F, 0.0F + f, 0.0F);
        LeftLeg = new NopModelPart(64, 32, 40, 16);
        LeftLeg.mirror = true;
        LeftLeg.addBox(-2F, 4F, -2F, 4, 12, 4);
        LeftLeg.setPos(3F, 0.0F + f, 0.0F);
        unicornarm = new NopModelPart(64, 32, 40, 16);
        unicornarm.addBox(-3F, -2F, -2F, 4, 12, 4);
        ...
        Tail[0] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[0].addTopPlane(-2F + f8, -7F + f9, 16F + f10, 4, 4);
        Tail[0].setPos(f11, f12 + f, f13);
        Tail[1] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[1].addTopPlane(-2F + f8, 9F + f9, 16F + f10, 4, 4);
        Tail[1].setPos(f11, f12 + f, f13);
        Tail[2] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[2].addBackPlane(-2F + f8, -7F + f9, 16F + f10, 4, 8);
        Tail[2].setPos(f11, f12 + f, f13);
        Tail[3] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[3].addBackPlane(-2F + f8, -7F + f9, 20F + f10, 4, 8);
        Tail[3].setPos(f11, f12 + f, f13);
        Tail[4] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[4].addBackPlane(-2F + f8, 1.0F + f9, 16F + f10, 4, 8);
        Tail[4].setPos(f11, f12 + f, f13);
        Tail[5] = new ModelPlaneRenderer(64, 32, 32, 0);
        Tail[5].addBackPlane(-2F + f8, 1.0F + f9, 20F + f10, 4, 8);
        Tail[5].setPos(f11, f12 + f, f13);
        Tail[6] = new ModelPlaneRenderer(64, 32, 36, 0);
        Tail[6].mirror = true;
        Tail[6].addSidePlane(2.0F + f8, -7F + f9, 16F + f10, 8, 4);
        Tail[6].setPos(f11, f12 + f, f13);
        Tail[7] = new ModelPlaneRenderer(64, 32, 36, 0);
        Tail[7].addSidePlane(-2F + f8, -7F + f9, 16F + f10, 8, 4);
        Tail[7].setPos(f11, f12 + f, f13);
        Tail[8] = new ModelPlaneRenderer(64, 32, 36, 0);
        Tail[8].mirror = true;
        Tail[8].addSidePlane(2.0F + f8, 1.0F + f9, 16F + f10, 8, 4);
        Tail[8].setPos(f11, f12 + f, f13);
        Tail[9] = new ModelPlaneRenderer(64, 32, 36, 0);
        Tail[9].addSidePlane(-2F + f8, 1.0F + f9, 16F + f10, 8, 4);
        ...
        float f15 = 0.0F;
        float f16 = 0.0F;
        LeftWing = new NopModelPart[3];
        LeftWing[0] = new NopModelPart(64, 32, 56, 16);
        LeftWing[0].mirror = true;
        LeftWing[0].addBox(4F, 5F, 2.0F, 2, 6, 2);
        LeftWing[0].setPos(f14, f15 + f, f16);
        LeftWing[1] = new NopModelPart(64, 32, 56, 16);
        LeftWing[1].mirror = true;
        LeftWing[1].addBox(4F, 5F, 4F, 2, 8, 2);
        LeftWing[1].setPos(f14, f15 + f, f16);
        LeftWing[2] = new NopModelPart(64, 32, 56, 16);
        LeftWing[2].mirror = true;
        LeftWing[2].addBox(4F, 5F, 6F, 2, 6, 2);
        LeftWing[2].setPos(f14, f15 + f, f16);
        RightWing = new NopModelPart[3];
        RightWing[0] = new NopModelPart(64, 32, 56, 16);
        RightWing[0].addBox(-6F, 5F, 2.0F, 2, 6, 2);
        RightWing[0].setPos(f14, f15 + f, f16);
        RightWing[1] = new NopModelPart(64, 32, 56, 16);
        RightWing[1].addBox(-6F, 5F, 4F, 2, 8, 2);
        RightWing[1].setPos(f14, f15 + f, f16);
        RightWing[2] = new NopModelPart(64, 32, 56, 16);
        RightWing[2].addBox(-6F, 5F, 6F, 2, 6, 2);
        RightWing[2].setPos(f14, f15 + f, f16);
        float f17 = f2 + 4.5F;
        float f18 = f3 + 5F;
        float f19 = f4 + 6F;
        LeftWingExt = new NopModelPart[7];
        LeftWingExt[0] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[0].mirror = true;
        LeftWingExt[0].addBox(0.0F, 0.0F, 0.0F, 1, 8, 2 + 0.1F);
        LeftWingExt[0].setPos(f17, f18 + f, f19);
        LeftWingExt[1] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[1].mirror = true;
        LeftWingExt[1].addBox(0.0F, 8F, 0.0F, 1, 6, 2 + 0.1F);
        LeftWingExt[1].setPos(f17, f18 + f, f19);
        LeftWingExt[2] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[2].mirror = true;
        LeftWingExt[2].addBox(0.0F, -1.2F, -0.2F, 1, 8, 2 - 0.2F);
        LeftWingExt[2].setPos(f17, f18 + f, f19);
        LeftWingExt[3] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[3].mirror = true;
        LeftWingExt[3].addBox(0.0F, 1.8F, 1.3F, 1, 8, 2 - 0.1F);
        LeftWingExt[3].setPos(f17, f18 + f, f19);
        LeftWingExt[4] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[4].mirror = true;
        LeftWingExt[4].addBox(0.0F, 5F, 2.0F, 1, 8, 2);
        LeftWingExt[4].setPos(f17, f18 + f, f19);
        LeftWingExt[5] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[5].mirror = true;
        LeftWingExt[5].addBox(0.0F, 0.0F, -0.2F, 1, 6, 2 + 0.3F);
        LeftWingExt[5].setPos(f17, f18 + f, f19);
        LeftWingExt[6] = new NopModelPart(64, 32, 56, 19);
        LeftWingExt[6].mirror = true;
        LeftWingExt[6].addBox(0.0F, 0.0F, 0.2F, 1, 3, 2 + 0.2F);
        LeftWingExt[6].setPos(f17, f18 + f, f19);
        float f20 = f2 - 4.5F;
        float f21 = f3 + 5F;
        float f22 = f4 + 6F;
        RightWingExt = new NopModelPart[7];
        RightWingExt[0] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[0].mirror = true;
        RightWingExt[0].addBox(0.0F, 0.0F, 0.0F, 1, 8, 2 + 0.1F);
        RightWingExt[0].setPos(f20, f21 + f, f22);
        RightWingExt[1] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[1].mirror = true;
        RightWingExt[1].addBox(0.0F, 8F, 0.0F, 1, 6, 2 + 0.1F);
        RightWingExt[1].setPos(f20, f21 + f, f22);
        RightWingExt[2] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[2].mirror = true;
        RightWingExt[2].addBox(0.0F, -1.2F, -0.2F, 1, 8, 2 - 0.2F);
        RightWingExt[2].setPos(f20, f21 + f, f22);
        RightWingExt[3] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[3].mirror = true;
        RightWingExt[3].addBox(0.0F, 1.8F, 1.3F, 1, 8, 2 - 0.1F);
        RightWingExt[3].setPos(f20, f21 + f, f22);
        RightWingExt[4] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[4].mirror = true;
        RightWingExt[4].addBox(0.0F, 5F, 2.0F, 1, 8, 2);
        RightWingExt[4].setPos(f20, f21 + f, f22);
        RightWingExt[5] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[5].mirror = true;
        RightWingExt[5].addBox(0.0F, 0.0F, -0.2F, 1, 6, 2 + 0.3F);
        RightWingExt[5].setPos(f20, f21 + f, f22);
        RightWingExt[6] = new NopModelPart(64, 32, 56, 19);
        RightWingExt[6].mirror = true;
        RightWingExt[6].addBox(0.0F, 0.0F, 0.2F, 1, 3, 2 + 0.2F);
    ...
    public void setupAnim(T npc, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        for(int i = 0; i < Tail.length; i++)
        {
            ...
            {
                Tail[i].zRot = Mth.cos(limbSwing * 0.8F) * 0.2F * limbSwingAmount;
            }
        }
...
//        {
//            f12 = Mth.sin(Mth.sqrt(f5) * 3.141593F * 2.0F) * 0.2F;
//        }
        ...
        float f13 = Mth.sin(Body.yRot) * 5F;
        float f14 = Mth.cos(Body.yRot) * 5F;
        float f15 = 4F;
        if(isSneak && !isFlying)
        {
            f15 = 0.0F;
...
//            f16 *= f16 * f16;
//            f16 = 1.0F - f16;
//            float f22 = Mth.sin(f16 * 3.141593F);
//            float f28 = Mth.sin(f5 * 3.141593F);
...
//        }
        ...
        } else
        {
            ...
            {
                WingRotateAngleY = Mth.sin(ageInTicks * 0.067F * 8F) * 1.0F;
                WingRotateAngleZ = Mth.sin(ageInTicks * 0.067F * 8F) * 1.0F;
            ...
            for(int k5 = 0; k5 < Tail.length; k5++)
            {
                ...
                if(rainboom)
                {
                    Tail[k5].xRot = 1.571F + 0.1F * Mth.sin(limbSwing);
                } else
                {
                    Tail[k5].xRot = f61;
                }
...
//        }
        ...
        if(aimedBow)
        {
            ...
            unicornarm.zRot += Mth.cos(f31 * 0.09F) * 0.05F + 0.05F;
            unicornarm.xRot += Mth.sin(f31 * 0.067F) * 0.05F;
            if(!isUnicorn)
            {
...
//
//    protected void renderGlow(EntityRendererProvider.Context rendermanager, Player entityplayer)
//    {
...
////            renderengine.bindForSetup("/fx/glow.png");
//            LevelRenderer tessellator = Tesselator.getInstance().getLevelRenderer();
//            float f = 0.0F;
//            float f1 = 0.25F;
//            float f2 = 0.0F;
//            float f3 = 0.25F;
...
//            float f5 = 0.5F;
//            float f6 = 0.25F;
//    		tessellator.func_181668_a(7, DefaultVertexFormat.field_181710_j);
