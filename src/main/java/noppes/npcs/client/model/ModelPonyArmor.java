...
//        }
        ...
        if(aimedBow && !isUnicorn)
        {
            ...
            float f29 = age;
            rightarm.zRot += Mth.cos(f29 * 0.09F) * 0.05F + 0.05F;
            rightarm.xRot += Mth.sin(f29 * 0.067F) * 0.05F;
            rightarm2.zRot = 0.0F;
            rightarm2.yRot = -(0.1F - f20 * 0.6F) + head.yRot;
            rightarm2.xRot = 4.712F + head.xRot;
            rightarm2.xRot -= f20 * 1.2F - f25 * 0.4F;
            rightarm2.zRot += Mth.cos(f29 * 0.09F) * 0.05F + 0.05F;
            rightarm2.xRot += Mth.sin(f29 * 0.067F) * 0.05F;
