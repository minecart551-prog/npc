...
public class ContainerNPCInv extends AbstractContainerMenu {
    ...
    public ContainerNPCInv(int containerId, Inventory playerInventory, int entityId){
    	...
    	addSlot(new SlotNPCArmor(npc.inventory, 0, 9, 22, EquipmentSlot.HEAD));
    	addSlot(new SlotNPCArmor(npc.inventory, 1, 9, 40, EquipmentSlot.CHEST));
    	addSlot(new SlotNPCArmor(npc.inventory, 2, 9, 58, EquipmentSlot.LEGS));
    	addSlot(new SlotNPCArmor(npc.inventory, 3, 9, 76, EquipmentSlot.FEET));
