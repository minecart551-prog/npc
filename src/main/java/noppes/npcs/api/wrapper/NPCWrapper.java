...
public class NPCWrapper<T extends EntityNPCInterface> extends EntityLivingWrapper<T> implements ICustomNpc{
	...
	public void setOffset(int x, int y, int z){
		entity.ais.bodyOffsetX = ValueUtil.correctFloat(x, 0, 10);
		entity.ais.bodyOffsetY = ValueUtil.correctFloat(y, 0, 100);
		entity.ais.bodyOffsetZ = ValueUtil.correctFloat(z, 0, 10);
		entity.updateClient = true;
	}
	...
	public void setRotation(float rotation){
		...
		if(entity.ais.orientation != r) {
			...
			Packets.sendNearby(entity, new PacketNpcRotationUpdate(entity.getId(), entity.ais.orientation));
		}
	}
