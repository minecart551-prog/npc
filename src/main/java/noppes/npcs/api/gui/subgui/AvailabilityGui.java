...
public class AvailabilityGui {
    ...
    public static CustomGuiWrapper open(Availability availability, IPlayer player){
        ...
        gui.addButton(1, "availability.selectdialog", 20, 12, 240, 20)
                .setOnPress((gui2, bb) -> gui2.openSubGui(AvailabilityGui.openDialog(availability, player)));
        gui.addButton(2, "availability.selectquest", 20, 35, 240, 20)
                .setOnPress((gui2, bb) -> gui2.openSubGui(AvailabilityGui.openQuest(availability, player)));
        gui.addButton(3, "availability.selectscoreboard", 20, 58, 240, 20)
                .setOnPress((gui2, bb) -> gui2.openSubGui(AvailabilityGui.openScoreboard(availability, player)));

        gui.addButtonList(4, 4, 90, 60, 20)
                .setValues("availability.always","availability.is","availability.isnot")
                .setSelected(availability.factionAvailable.ordinal())
                .setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(5, 66, 90, 66, 20)
                .setValues("faction.friendly","faction.neutral","faction.unfriendly")
                .setSelected(availability.factionStance.ordinal())
                .setOnPress((gui2, bb) -> availability.setFactionAvailabilityStance(((IButtonList)bb).getSelected()));
        gui.addButton(6, "availability.selectfaction", 134, 90, 120, 20)
                .setOnPress((gui2, bb) -> gui2.openSubGui(SelectorGui.openFaction(availability.factionId, player, (id) -> {
                    availability.factionId = id;
                    enableFactionButtons(gui, availability.factionAvailable, availability.factionId, 5, 6);
                })));
        gui.addButton(7, "X", 256, 90, 20, 20)
                .setOnPress((gui2, bb) -> {
                    availability.factionId = -1;
                    enableFactionButtons(gui, availability.factionAvailable, availability.factionId, 5, 6);
                });
        ...
        gui.addButtonList(8, 4, 112, 60, 20)
                .setValues("availability.always","availability.is","availability.isnot")
                .setSelected(availability.faction2Available.ordinal())
                .setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(9, 66, 112, 66, 20)
                .setValues("faction.friendly","faction.neutral","faction.unfriendly")
                .setSelected(availability.faction2Stance.ordinal())
                .setOnPress((gui2, bb) -> availability.setFaction2AvailabilityStance(((IButtonList)bb).getSelected()));
        gui.addButton(10, "availability.selectfaction", 134, 112, 120, 20)
                .setOnPress((gui2, bb) -> gui2.openSubGui(SelectorGui.openFaction(availability.faction2Id, player, (id) -> {
                    availability.faction2Id = id;
                    enableFactionButtons(gui, availability.faction2Available, availability.faction2Id, 9, 10);
                })));
        gui.addButton(11, "X", 256, 112, 20, 20)
                .setOnPress((gui2, bb) -> {
                    availability.faction2Id = -1;
                    enableFactionButtons(gui, availability.faction2Available, availability.faction2Id, 5, 6);
                });
        ...
        gui.addButtonList(13, 66, 137, 70, 20)
                .setValues("availability.wholeday","availability.night","availability.day")
                .setSelected(availability.daytime.ordinal())
                .setOnPress((gui2, bb) -> availability.daytime = EnumDayTime.values()[((IButtonList)bb).getSelected()]);

        gui.addLabel(14, "availability.minlevel", 4, 164, 90, 8);
        gui.addTextField(15, 100, 159, 60, 20).setCharacterType(1).setMinMax(0, Integer.MAX_VALUE).setInteger(availability.minPlayerLevel)
                .setOnFocusLost((gui2, textfield) -> availability.minPlayerLevel = textfield.getInteger());

        gui.addButton(16, "gui.done", 90, 190, 100, 20)
                .setOnPress((gui2, bb) -> gui2.close());
    ...
    public static CustomGuiWrapper openDialog(Availability availability, IPlayer player) {
        ...
        //gui.addLabel(0, "availability.available", 0, 4, 320, 8).setCentered(true);

        gui.addButtonList(1, 4, 14, 60, 20).setValues("availability.always","availability.after","availability.before")
                .setSelected(availability.dialogAvailable.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(11, 4, 37, 60, 20).setValues("availability.always","availability.after","availability.before")
                .setSelected(availability.dialog2Available.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(21, 4, 60, 60, 20).setValues("availability.always","availability.after","availability.before")
                .setSelected(availability.dialog3Available.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(31, 4, 83, 60, 20).setValues("availability.always","availability.after","availability.before")
                .setSelected(availability.dialog4Available.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButton(16, "gui.done", 110, 110, 100, 20)
                .setOnPress((gui2, bb) -> gui2.close());
        return gui;
    }
    ...
    public static CustomGuiWrapper openQuest(Availability availability, IPlayer player) {
        ...
        gui.addButtonList(1, 4, 14, 60, 20).setValues("availability.always","availability.after","availability.before","availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart")
                .setSelected(availability.questAvailable.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(11, 4, 37, 60, 20).setValues("availability.always","availability.after","availability.before","availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart")
                .setSelected(availability.quest2Available.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(21, 4, 60, 60, 20).setValues("availability.always","availability.after","availability.before","availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart")
                .setSelected(availability.quest3Available.ordinal()).setOnPress((gui2, bb) -> {
        ...
        gui.addButtonList(31, 4, 83, 60, 20).setValues("availability.always","availability.after","availability.before","availability.whenactive", "availability.whennotactive", "availability.completed", "availability.canStart")
                .setSelected(availability.quest4Available.ordinal()).setOnPress((gui2, bb) -> {
    ...
    public static CustomGuiWrapper openScoreboard(Availability availability, IPlayer player) {
        ...
        gui.addTextField(1, 4, 14, 140, 20).setText(availability.scoreboardObjective)
                .setOnFocusLost((gui2, textfield) -> availability.scoreboardObjective = textfield.getText());
        gui.addButtonList(2, 148, 14, 90, 20).setValues("availability.smaller", "availability.equals", "availability.bigger")
                .setSelected(availability.scoreboardType.ordinal()).setOnPress((gui2, bb) -> availability.scoreboardType = EnumAvailabilityScoreboard.values()[((IButtonList)bb).getSelected()]);
        gui.addTextField(3, 244, 14, 60, 20).setCharacterType(1).setInteger(availability.scoreboardValue)
                .setOnFocusLost((gui2, textfield) -> availability.scoreboardValue = textfield.getInteger());

        gui.addTextField(11, 4, 37, 140, 20).setText(availability.scoreboard2Objective)
                .setOnFocusLost((gui2, textfield) -> availability.scoreboard2Objective = textfield.getText());
        gui.addButtonList(12, 148, 37, 90, 20).setValues("availability.smaller", "availability.equals", "availability.bigger")
                .setSelected(availability.scoreboard2Type.ordinal()).setOnPress((gui2, bb) -> availability.scoreboard2Type = EnumAvailabilityScoreboard.values()[((IButtonList)bb).getSelected()]);
        gui.addTextField(13, 244, 37, 60, 20).setCharacterType(1).setInteger(availability.scoreboard2Value)
                .setOnFocusLost((gui2, textfield) -> availability.scoreboard2Value = textfield.getInteger());
