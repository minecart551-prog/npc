...
public class AssetsGui {
    ...
    public static CustomGuiWrapper openTexture(String resource, IPlayer player, IEntity entity, AssetsGui.SelectionCallback callback){
        ...
        gui.addAssetsSelector(11, 4, 4, 300, 204).setSelected(resource).setOnPress((gui2, assets) -> gui2.close())
                .setOnChange((gui2, assets) -> {callback.call(assets.getSelected()); display.setEntity(entity); gui2.update(display);});
