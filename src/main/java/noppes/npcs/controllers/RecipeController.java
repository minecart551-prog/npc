...
//        ForgeRegistry<net.minecraft.world.item.crafting.IRecipe> reg = (ForgeRegistry<net.minecraft.world.item.crafting.IRecipe>)ForgeRegistries.RECIPES;
//        reg.unfreeze();
//        reg.clear();
//        CraftingHelper.loadRecipes(false);
//		ForgeRegistry reg = (ForgeRegistry) Registry;
//		reg.unfreeze();
//		Iterator<Entry<ResourceLocation, net.minecraft.world.item.crafting.IRecipe>> list = reg.getEntries().iterator();
//		while(list.hasNext()){
//			Entry<ResourceLocation, net.minecraft.world.item.crafting.IRecipe> rec = list.next();
//			net.minecraft.world.item.crafting.IRecipe recipe = rec.getValue();
