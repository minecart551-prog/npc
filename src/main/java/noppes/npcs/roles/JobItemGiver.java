...
public class JobItemGiver extends JobInterface{
	...
	public CompoundTag save(CompoundTag nbttagcompound) {
		...
		nbttagcompound.put("igAvailability", availability.save(new CompoundTag()));
	...
	private boolean givePlayerItems(Player player,
	...
	public boolean aiShouldExecute() {
		...
		toCheck = npc.level().getEntitiesOfClass(Player.class, npc.getBoundingBox().inflate(3, 3, 3));
		toCheck.removeAll(recentlyChecked);

		List<Player> listMax = npc.level().getEntitiesOfClass(Player.class, npc.getBoundingBox().inflate(10, 10, 10));
